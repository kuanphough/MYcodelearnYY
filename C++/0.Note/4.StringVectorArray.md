...
> [!note] EXample 22.1：const* char常量与字符串辨析
```cpp
int main()
{
...
#### [String Literals in C++](https://www.youtube.com/watch?v=FeHZHF0f2dw&list=PLlrATfBNZ98dudnM48yfGUldqGD0S4FFb&index=32)

就是双引号里的字符串，例如：`"Cherno";`，这是一串7个字符的字符串，最后还有个`/0`。或者 
```cpp

char name[] = "Cherno"; 0

```
> [!note] EXample 22.4：空终止符
```cpp
#include <iostream>
#include <string>
#include <stdlib.h>
...
> [!note] EXample 22.5：Release 模式下修改字符串
```cpp
#include <iostream>
#include <string>
#include <stdlib.h>
